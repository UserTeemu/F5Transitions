...
import dev.userteemu.f5transitions.asm.hooks.GeneralEntityRenderingHook;
...
import static dev.userteemu.f5transitions.asm.CommonInstructions.getTransitionHelper;
import static dev.userteemu.f5transitions.asm.CommonInstructions.isTransitionActive;
