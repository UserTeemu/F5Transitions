...
public class EntityRendererTransformer implements ITransformer {
    public static FieldNode transitionHelper = new FieldNode(Opcodes.ACC_PUBLIC, "perspectiveTransitionHelper", "Ldev/userteemu/f5transitions/TransitionHelper;", null, null);
                ...
                while (iterator.hasNext()) {
                    ...
                    if (
                        ...
                        if (invokeName.equals("rayTraceBlocks") || invokeName.equals("func_72933_a")) {
                            methodNode.instructions.set(node, new MethodInsnNode(Opcodes.INVOKESTATIC, "dev/userteemu/f5transitions/utils/RaytracingUtil", "rayTraceBlocks", "(Lnet/minecraft/world/World;Lnet/minecraft/util/Vec3;Lnet/minecraft/util/Vec3;)Lnet/minecraft/util/MovingObjectPosition;", false));
                            break;
                        }
                    }
                }
    ...
    private InsnList initTransitionHelper() {
        ...
        list.add(new TypeInsnNode(Opcodes.NEW, "dev/userteemu/f5transitions/TransitionHelper"));
        list.add(new InsnNode(Opcodes.DUP));
        list.add(new VarInsnNode(Opcodes.ALOAD, 0));
        list.add(new VarInsnNode(Opcodes.ALOAD, 1));
        list.add(new MethodInsnNode(Opcodes.INVOKESPECIAL, "dev/userteemu/f5transitions/TransitionHelper", "<init>", "(Lnet/minecraft/client/renderer/EntityRenderer;Lnet/minecraft/client/Minecraft;)V", false));
