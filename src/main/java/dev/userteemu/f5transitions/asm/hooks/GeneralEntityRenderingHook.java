package dev.userteemu.f5transitions.asm.hooks;
...
public class GeneralEntityRenderingHook {
    ...
    public static InsnList canApplyTransitionsToEntity(int indexOfEntityVariable) {
        ...
        list.add(new MethodInsnNode(Opcodes.INVOKESTATIC, "dev/userteemu/f5transitions/asm/hooks/GeneralEntityRenderingHook", "canApplyTransitionsToEntity", "(Lnet/minecraft/entity/Entity;)Z", false));
        return list;
    }
    ...
    public static InsnList setContext(boolean state) {
        ...
        list.add(new FieldInsnNode(Opcodes.PUTSTATIC, "dev/userteemu/f5transitions/asm/hooks/GeneralEntityRenderingHook", "isRightRenderContextForTransitions", "Z"));
        return list;
    }
}
