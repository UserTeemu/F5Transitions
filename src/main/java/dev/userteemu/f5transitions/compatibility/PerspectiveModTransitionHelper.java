...
import dev.userteemu.f5transitions.config.PerspectiveModCompatibilityOptions;
import dev.userteemu.f5transitions.perspectives.DJPerspectiveModPerspective;
...
public class PerspectiveModTransitionHelper {
    ...
    public float getMultipliedFacingValueForPerspectiveMod(float value, Entity entity, boolean isYaw, boolean isPreviousValue) {
        ...
        return normalValue + (difference * EaseProperty.ROTATION.getValue(progress));
    }
